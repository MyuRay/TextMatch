              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <ul className="list-disc list-inside text-sm text-muted-foreground ml-4 space-y-1">
                    ...
                    <li>当サービスは、個人間取引の場を提供するプラットフォームです。商品の内容や品質、取引条件については、出品者および購入者の間で合意・確認のうえで取引を行ってください。基本的に、取引に関するトラブルについては当事者間で解決していただくことをお願いしておりますが、当サービスの規約に反する重大な事案、またはユーザーからの申し出があった場合には、運営が必要と判断した場合に限り対応・調査・仲裁を行う場合があります。</li>
                    <li>クレジットカード決済を利用する関係上、決済に関する問題や返金に関しては、当サービス運営者がStripeとの連携を通じて対応いたします。ご不明な点があればサポートまでご連絡ください。</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
